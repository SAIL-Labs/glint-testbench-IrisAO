...
import os
#os.environ['LD_LIBRARY_PATH'] = '/home/glint/miniconda3/lib:' + os.environ.get('LD_LIBRARY_PATH', '')

#import sys
#import ipdb
#sys.path.insert(0, '/home/glint/Documents/git.repos/glint-testbench-IrisAO/glint_ubuntu/IrisAO_PythonAPI')

#from IrisAO_PythonAPI import IrisAO_Python as IAOW
print('hi3')
print(os.getcwd())
#from .IrisAO_PythonAPI import  IrisAO_Python as IAOW # test
print('hi5')
